...
int main(int argc, char **argv)
{
    ...
    for (uint32_t i = 0; i < NUM_CPUS; i++)
    {
        ...
        cout << "Number of Instructions Predicted Correct " << ooo_cpu[i].vp_correct_mem_executions + ooo_cpu[i].vp_correct_reg_executions << std::endl;
        cout << "Number of Instructions Predicted Incorrect " << ooo_cpu[i].vp_incorrect_mem_executions + ooo_cpu[i].vp_incorrect_reg_executions << std::endl;
